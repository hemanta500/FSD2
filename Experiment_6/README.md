# Experiment–6: Form Validation using React & MUI

# Description
This experiment demonstrates how to build a **Login Form** using **React (Vite)** and **Material UI (MUI)** with proper **form validation**, **state management**, and **responsive UI styling**.
